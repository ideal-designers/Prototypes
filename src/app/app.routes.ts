...
export const routes: Routes = [
  ...
  },
  {
    ...
    {
    path: 'permissions-legend-v3',
    loadComponent: () =>
      import('./prototypes/permissions-legend-v3/permissions-legend-v3.component').then(m => m.PermissionsLegendV3Component),
  },
    {
