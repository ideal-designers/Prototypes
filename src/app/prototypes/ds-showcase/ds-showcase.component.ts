...
export class DsShowcaseComponent implements OnInit, OnDestroy {
  ...
  iconNames: import('../../shared/ds').FvdrIconName[] = [
    ...
    // 16x16 — assistant chrome: new session + display modes
    'new-session','floating-mode','sidebar-mode',
    'panel-right','panel-window',
    // 24x24 — AI assistant sparkle
    'ai-assistant',
    // 20x20 — Ideon mark: brand-gradient (always-on) + colour-inheriting default
    'ideon','ideon-default',
    // 24x24 — Theme
