...
import { DS_COMPONENTS, ToastService, ToastAction } from '../../shared/ds';
  ...
  <main class="doc-main" *ngIf="entry">
    ...
    <section class="doc-section">
      ...
      <ng-container [ngSwitch]="componentId">
        ...
        <!-- REDACTION MARK GROUP (combined / expandable) -->
        <ng-container *ngSwitchCase="'redaction-mark-group'">
          <div class="examples-group">
            <h3 class="examples-group__title">Expanded — draft group (click header to toggle)</h3>
            <div class="examples-col" style="max-width: 320px;">
              <fvdr-redaction-mark-group
                type="personal-name"
                title="Andrew State"
                status="draft"
                [marks]="demoRedactionDraftMarks"
                [(expanded)]="demoRedactionGroupOpen"
                [selected]="true"></fvdr-redaction-mark-group>
            </div>
          </div>

          <div class="examples-group">
            <h3 class="examples-group__title">Collapsed</h3>
            <div class="examples-col" style="max-width: 320px;">
              <fvdr-redaction-mark-group type="email" title="vladyslav.orel@gmail.com" status="applied" [marks]="demoRedactionAppliedMarks" [expanded]="false"></fvdr-redaction-mark-group>
              <fvdr-redaction-mark-group type="date-time" title="May 4, 2026" status="draft" [marks]="demoRedactionDraftMarks" [expanded]="false"></fvdr-redaction-mark-group>
            </div>
          </div>

          <div class="examples-group">
            <h3 class="examples-group__title">Applied group, expanded</h3>
            <div class="examples-col" style="max-width: 320px;">
              <fvdr-redaction-mark-group type="iban" title="ES91 2100 0418 4502 0005" status="applied" [marks]="demoRedactionAppliedMarks" [expanded]="true"></fvdr-redaction-mark-group>
            </div>
          </div>

          <div class="examples-group">
            <h3 class="examples-group__title">Other types, collapsed</h3>
            <div class="examples-col" style="max-width: 320px;">
              <fvdr-redaction-mark-group type="phone" title="+380681234567" status="draft" [marks]="demoRedactionDraftMarks" [expanded]="false"></fvdr-redaction-mark-group>
              <fvdr-redaction-mark-group type="text-mark" title="Text goes here…" status="draft" [marks]="demoRedactionAppliedMarks" [expanded]="false"></fvdr-redaction-mark-group>
              <fvdr-redaction-mark-group type="redacted-area" title="Redacted area" status="applied" [marks]="demoRedactionAppliedMarks" [expanded]="false"></fvdr-redaction-mark-group>
            </div>
          </div>
        </ng-container>
...
export class DsComponentPageComponent implements OnInit, OnDestroy {
  ...
  // ── Redaction mark group demo data ──
  demoRedactionDraftMarks = [
    { pageLabel: 'Page 1', status: 'draft' as const, selected: true },
    { pageLabel: 'Page 2', status: 'draft' as const },
    { pageLabel: 'Page 5', status: 'draft' as const },
    { pageLabel: 'Page 8', status: 'draft' as const },
    { pageLabel: 'Page 12', status: 'draft' as const },
  ];
  demoRedactionAppliedMarks = [
    { pageLabel: 'Page 3', status: 'applied' as const },
    { pageLabel: 'Page 4', status: 'applied' as const },
    { pageLabel: 'Page 7', status: 'applied' as const },
  ];
  demoRedactionGroupOpen = true;
