...
const chip: ComponentDocEntry = {
  ...
  tokens: [
    { token: '--chip-bg-default',  value: '#eceef9', usage: 'Default chip background (dark #2E3345)' },
    { token: '--chip-bg-green',    value: '#eaf6ed', usage: 'Green / theme chip background (dark #1E3B2E)' },
    { token: '--chip-bg-yellow',   value: '#fff5e0', usage: 'Yellow chip background (dark #3D3418)' },
    { token: '--chip-bg-orange',   value: '#ffede1', usage: 'Orange chip background (dark #3D2C1D)' },
    { token: '--chip-bg-lime',     value: '#eef6e3', usage: 'Lime chip background (dark #2C3A1E)' },
    { token: '--chip-bg-teal',     value: '#e8fafa', usage: 'Teal chip background (dark #1B3A3D)' },
    { token: '--chip-bg-danger',   value: '#fff0ee', usage: 'Danger chip background (dark #3F2622)' },
    { token: '--chip-bg-blue',     value: '#eaf2fa', usage: 'Blue chip background (dark #1E3350)' },
    { token: '--chip-bg-indigo',   value: '#f0f0ff', usage: 'Indigo chip background (dark #292E52)' },
    { token: '--chip-bg-purple',   value: '#f9f1ff', usage: 'Purple chip background (dark #33254A)' },
    { token: '--chip-bg-magenta',  value: '#feeff9', usage: 'Magenta chip background (dark #3F2440)' },
    { token: '--chip-bg-grey',     value: '#f7f7f7', usage: 'Grey chip background (dark #2C3033)' },
    { token: '--chip-bg-coffee',   value: '#f0edea', usage: 'Coffee chip background (dark #38312B)' },
    { token: '--color-text-primary', value: '#1f2129', usage: 'Text color on all chip variants' },
  ],
  usedIn: ['Multiselect', 'Activity Log (filter chips)', 'AI Assistant › Documents (label chips, version pill)'],
