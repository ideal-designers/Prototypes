...
const SLUG = 'permissions-legend-v3';
...
@Component({
  selector: 'fvdr-permissions-legend-v3',
  standalone: true,
...
export class PermissionsLegendV3Component implements OnInit, AfterViewInit, OnDestroy {
