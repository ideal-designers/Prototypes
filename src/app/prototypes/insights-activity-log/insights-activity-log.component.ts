...
@Component({
        ...
        <header class="page-header">
          ...
          <div class="header-actions">
            <button class="icon-btn" (click)="toggleTheme()" [title]="isDark ? 'Light mode' : 'Dark mode'">
              <fvdr-icon [name]="isDark ? 'theme-light' : 'theme-dark'"></fvdr-icon>
            </button>
            <button class="icon-btn" title="Help">
              <fvdr-icon name="help"></fvdr-icon>
            </button>
            <fvdr-avatar initials="IR" size="md" color="#2C9C74" textColor="#ffffff"></fvdr-avatar>
          </div>
        </header>
          ...
          <div class="filter-bar">
            ...
            <div class="filter-bar-right">
              <button class="action-btn">
                <fvdr-icon name="download"></fvdr-icon>
                <span>Export</span>
              </button>
              <button class="action-btn">
                <fvdr-icon name="bell"></fvdr-icon>
                <span>Subscribe</span>
              </button>
            </div>
          </div>
  ...
  styles: [`
    ...
    .breadcrumb-sep {
      color: var(--color-stone-500, #BBBDC8);
      font-size: 16px;
    }
